...
const handleRemovePlayer = async () => {
  ...
  return (
    <AdminLayout pageTitle ="Gestion des equipes">
     {isVisible && <div className="bg-zinc-950 text-white p-4 sm:p-6 font-sans">
